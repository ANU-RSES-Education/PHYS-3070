 ...
 * __Plot the results using python / R / Basic / ...__

 OR

* __use a traditional curve-sketching approach to indicate maxima / minima / asymptotic behaviours and how those
   change with the parameters of the model.__
