...
However, these rich datasets are a relatively recent luxury
and we actually learn a great deal more about the Earth if
we reconstruct some of the arguments for plate tectonics that
were made in the absence of strong evidence.

It also helps to think about some of the theories that are
equally plausible when the data are sparse.

```{=html}
<center>
<object data="../Figures/PDFs/PHYS3070_2_intro_history.pdf" type="application/pdf"
              width="450px" height="300px" width=">
    <p>It appears you don't have a PDF plugin for this browser.
    No biggie... you can <a href="../Figures/PDFs/PHYS3070_2_intro_history.pdf"> click here to
